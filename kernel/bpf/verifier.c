 ...
 * make it consume minimal amount of memory. check_stack_write(env, ) access from
			       ...
			       int size, bool strict_alignment_once)
{
	...
	case PTR_TO_STACK:
		pointer_desc = "stack ";
		/* The stack spill tracking logic in check_stack_write(env, )
		 * and check_stack_read(env, ) relies on stack accesses being
		 * aligned.
		 */
		strict = true;
		break;
